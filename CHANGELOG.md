...
### Added
- `commit-with-review` skill: CodeRabbit review + structured commit workflow
- `feature-planner` skill: Phase-based feature planning with TDD quality gates and conductor pattern
